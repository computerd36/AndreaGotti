...
export interface ICopyISBNButtonProps {
    ISBN: string;
}

export function CopyISBNButton(props: ICopyISBNButtonProps) {

    function copyISBN() {
        navigator.clipboard.writeText(props.ISBN);
    }
    ...
    return (
        <button className="copy" onClick={copyISBN}>
            ...
            <span>
                ...
                <svg xmlSpace="preserve" viewBox="0 0 24 24" y="0" x="0" height="18" width="18" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" className="checkmark">
                    <g>
